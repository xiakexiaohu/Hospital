    ...
    <div class="easyui-accordion" data-options="border:false">
        ...
        <%--</div>--%>
            ...
            <div title="问卷管理" class="site_menu">
                <a href="javascript:void(0)"  src="http://mbigdata.njust.edu.cn/manage/loginURL?username=${sessionScope.admin.email }&password=${sessionScope.admin.pwd }"  class="site-navi-tab">问卷详情</a></p>
            </div>
